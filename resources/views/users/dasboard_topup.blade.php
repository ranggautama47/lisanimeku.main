<html>
  <head>
    ...
    <link
      ...
      rel="stylesheet"
    />
    <link rel="stylesheet" href="{{ asset('ui/topup.css') }}">
    ...
    <script src="{{ asset('popup.js') }}" defer></script>
    <meta name="csrf-token" content="{{ csrf_token() }}">
  </head>
<body class="bg-black text-white">
   <header class="flex items-center justify-between p-4">
      <div class="flex items-center">
    <img src="{{ asset('asset/neko.png') }}" alt="Logo" class="mr-2 h-12"/>
  ...
  <div class="flex items-center bg-gray-800 rounded-full px-4 py-2 hover:bg-gray-700 transition">
    <img src="{{ asset('assets/img/berries.png') }}" class="h-5 w-5 mr-2"/>
  ...
  <div class="relative group bg-blue-200 rounded-full p-2 hover:bg-blue-300 transition">
    <div class="flex items-center space-x-2 cursor-pointer">
      <img src="{{ Auth::user()->profile_photo_url ?? 'https://github.com/mdo.png' }}"
           alt="{{ Auth::user()->name }}"
           class="h-10 w-10 rounded-full object-cover border-2 border-blue-500">
      <span class="hidden md:inline font-medium text-blue-700">{{ Auth::user()->name }}</span>
    </div>
    <!-- dropdown menu -->
